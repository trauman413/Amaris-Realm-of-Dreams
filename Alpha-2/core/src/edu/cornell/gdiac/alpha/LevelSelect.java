...
public class LevelSelect implements Screen, InputProcessor, ControllerListener {
    ...
    private static final String BACKGROUND_FILE = "images/level_select1.png";
    private static final String PROGRESS_FILE = "images/progressbar.png";
    private static final String PLAY_BTN_FILE = "images/play_level_select.png";
     ...
     */
    public LevelSelect(GameCanvas canvas, AssetManager manager) {
     ...
     */
    public LevelSelect(GameCanvas canvas, AssetManager manager, int millis) {
    ...
    public void resize(int width, int height) {
        ...
        centerY = (int)(BAR_HEIGHT_RATIO*height) - 50;
        centerX = width/2 - 115;
        heightY = height;
    }
