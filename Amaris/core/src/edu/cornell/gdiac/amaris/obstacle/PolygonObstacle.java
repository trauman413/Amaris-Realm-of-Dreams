 ...
 * alpha objects, but it will allow you to draw arbitrary shapes.
 *
 * Be careful with modifying this file.  Even if you have had computer
 * graphics, there are A LOT of subtleties in handling the alpha of
 * polygons.
 *
...
public class PolygonObstacle extends SimpleObstacle {
	...
	/** Shape information for this alpha object */
	 ...
	 * are measured in alpha units.  They tile the image according
	 ...
	 */
	public PolygonObstacle(float[] points, float x, float y, float width, float height) {
		super(x, y);
	...
	private void initShapes(float[] points) {
		...
		// Allocate space for alpha triangles.
