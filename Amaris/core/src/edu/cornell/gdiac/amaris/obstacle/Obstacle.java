...
import edu.cornell.gdiac.amaris.*;  // For GameCanvas

/**
 * Base model class to support collisions.
 *
 * Instances represents a body and/or a group of bodies.
 * There should be NO game controlling logic code in a alpha objects,
...
public abstract class Obstacle{
	...
	/** The alpha body for Box2D. */
	protected Body body;

	/** Object position (centered on the texture middle) */
	protected Vector2 position;
	/** Width of the object (used for collisions) */
	protected float width;
	/** Height of the object (used for collisions) */
	protected float height;
	/** Object velocity */
	protected Vector2 velocity;
	/** Reference to texture origin */
	protected Vector2 origin;
	/** Drawing scale to convert alpha units to pixels */
	...
	/// BodyDef Methods
	/**
	 * Returns the body type for Box2D alpha
	 *
	 ...
	 * external forces (e.g. gravity). DYNAMIC makes this is a full-blown alpha object.
	 *
	 * @return the body type for Box2D alpha
	 */
	...
	/**
	 * Returns the current position for this alpha body
	 *
	 ...
	 *
	 * @return the current position for this alpha body
	 */
	...
	/**
	 * Sets the current position for this alpha body
	 *
	 * This method does not keep a reference to the parameter.
	 *
	 * @param value  the current position for this alpha body
	 */
	 ...
	 * Sets the current position for this alpha body
	 *
	 * @param x  the x-coordinate for this alpha body
	 * @param y  the y-coordinate for this alpha body
	 */
	...
	/**
	 * Returns the x-coordinate for this alpha body
	 *
	 * @return the x-coordinate for this alpha body
	 */
	public float getX() {
	...
	/**
	 * Sets the x-coordinate for this alpha body
	 *
	 * @param value  the x-coordinate for this alpha body
	 */
	...
	/**
	 * Returns the y-coordinate for this alpha body
	 *
	 * @return the y-coordinate for this alpha body
	 */
	public float getY() {
	...
	/**
	 * Sets the y-coordinate for this alpha body
	 *
	 * @param value  the y-coordinate for this alpha body
	 */
	...
	/**
	 * Returns the linear velocity for this alpha body
	 *
	 * This method does NOT return a reference to the velocity vector. Changes to this
	 * vector will not affect the body.  However, it returns the same vector each time
	 * its is called, and so cannot be used as an allocator.
	 *
	 * @return the linear velocity for this alpha body
	 */
	...
	/**
	 * Sets the linear velocity for this alpha body
	 *
	 * This method does not keep a reference to the parameter.
	 *
	 * @param value  the linear velocity for this alpha body
	 */
	...
	/**
	 * Returns the x-velocity for this alpha body
	 *
	 * @return the x-velocity for this alpha body
	 */
	public float getVX() {
	...
	/**
	 * Sets the x-velocity for this alpha body
	 *
	 * @param value  the x-velocity for this alpha body
	 */
	...
	/**
	 * Returns the y-velocity for this alpha body
	 *
	 * @return the y-velocity for this alpha body
	 */
	public float getVY() {
	...
	/**
	 * Sets the y-velocity for this alpha body
	 *
	 * @param value  the y-velocity for this alpha body
	 */
	...
	/**
	 * Returns the angular velocity for this alpha body
	 *
	 * The rate of change is measured in radians per step
	 *
	 * @return the angular velocity for this alpha body
	 */
	...
	/**
	 * Sets the angular velocity for this alpha body
	 *
	 * @param value the angular velocity for this alpha body (in radians)
	 */
	 ...
	 *
	 * An sleeping body is one that has come to rest and the alpha engine has decided
	 ...
	 * its is called, and so cannot be used as an allocator.
	 *
	 * @return the center of mass for this alpha body
	 */
	...
	/**
	 * Sets the center of mass for this alpha body
	 *
	 * This method does not keep a reference to the parameter.
	 *
	 * @param value  the center of mass for this alpha body
	 */
	 ...
	 *
	 * A garbage collected object will be removed from the alpha world at
	 * the next time step.
	 *
	...
	/// DRAWING METHODS
	/**
	 * Returns the drawing scale for this alpha object
	 *
	 * The drawing scale is the number of pixels to draw before Box2D unit. Because
	 * mass is a function of area in Box2D, we typically want the alpha objects
	 * to be small.  So we decouple that scale from the alpha object.  However,
	 ...
	 *
	 * @return the drawing scale for this alpha object
	 */
	...
	/**
	 * Sets the alpha object tag.
	 *
	 * A tag is a string attached to an object, in order to identify it in debugging.
	 *
	 * @param  value    the alpha object tag
	 */
	...
	/**
	 * Create a new alpha object at the origin.
	 */
	protected Obstacle() {
		this(0,0);
	}
	...
	protected Obstacle(float x, float y) {
		...
		// Objects are alpha objects unless otherwise noted
	...
	/**
	 * Sets the drawing scale for this alpha object
	 *
	 * The drawing scale is the number of pixels to draw before Box2D unit. Because
	 * mass is a function of area in Box2D, we typically want the alpha objects
	 * to be small.  So we decouple that scale from the alpha object.  However,
	 ...
	 * We allow for the scaling factor to be non-uniform.
	 *
	 * @param value  the drawing scale for this alpha object
	 */
	 ...
	 * We allow for the scaling factor to be non-uniform.
	 *
	 * @param x  the x-axis scale for this alpha object
	 * @param y  the y-axis scale for this alpha object
	 */
	...
	/**
	 * Draws the texture alpha object.
	 *
	 ...
	 * The drawScale converts the alpha units to pixels.
	 *
...
//    }
	...
	/**
	 * Destroys the alpha Body(s) of this object if applicable,
	...
	/**
	 * Draws the outline of the alpha body.
	 *
