 ...
 *
 * This class implements a selection tool for dragging alpha objects with a mouse.
...
/**
 * Selection tool to move and drag alpha obstacles
 *
...
public class ObstacleSelector implements QueryCallback  {
    ...
    /**
     * Returns true if a alpha body is currently selected
     *
     * @return true if a alpha body is currently selected
     */
     ...
     *
     * Just because a alpha body was selected does not mean that an Obstacle was
    ...
    /**
     * Returns true if a alpha body was selected at the given position.
     *
     ...
     *
     * @param  x  the x-coordinate (in alpha space) to select
     * @param  y  the y-coordinate (in alpha space) to select
     *
     * @return true if a alpha body was selected at the given position.
     */
     ...
     *
     * @param  x  the x-coordinate (in alpha space) to move to
     * @param  y  the y-coordinate (in alpha space) to move to
     *
    ...
    /**
     * Deselects the alpha body, discontinuing any mouse movement.
     *
