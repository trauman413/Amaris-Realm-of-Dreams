 ...
 * hierarchy. All of the alpha methods in the class apply to the root, not the body.
...
public abstract class ComplexObstacle extends Obstacle {
    ...
    protected Body body;
	/** A complex alpha object has multiple bodies */
	...
	/**
	 * Creates a new complex alpha object at the origin.
	 */
	...
	/**
	 * Creates a new complex alpha object
	 * 
	 ...
	 * override for custom alpha objects.
	 *
