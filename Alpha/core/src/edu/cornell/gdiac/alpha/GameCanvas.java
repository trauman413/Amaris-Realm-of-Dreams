...
//        spriteCam.setToOrtho(false);
	...
	public void clear() {
		// Clear the screen
		Gdx.gl.glClearColor(0.737f, 0.64705f, 0.929f, 1.0f);
	...
	public void begin(float x, float y, float width) {
		...
		// spriteCam.setToOrtho(false, width, height);
		spriteCam.update();
		spriteCam.position.x = Math.max(Math.min(x, width - getWidth()/2.0f), getWidth()/2.0f + 1);
		//spriteCam.position.y = Math.max(Math.min(spriteCam.position.y, 1080 - getHeight()/2.0f - 145), getHeight()/2.0f + 145);
		spriteCam.position.y = Math.max(Math.min(y, 1080 - getHeight()/2.0f), getHeight()/2.0f + 1);
//		if (y >= getHeight()/2.0f) {
...
//		spriteCam.position.y = Math.max(Math.min(spriteCam.position.y, 1080 - getHeight()/2.0f - 145), getHeight()/2.0f + 145);
	...
	public void moveCam(float x, float y, float width) {
		if (x!=0 || y!=0) {
			...
			spriteCam.position.y = Math.max(Math.min(yIncr, 1080 - getHeight()/2.0f - 145), getHeight()/2.0f + 145);
			spriteCam.update();
		}
	}
...
//		spriteCam.position.x = prevX;
//		spriteCam.position.y = prevY;
		spriteCam.zoom = Math.max(spriteCam.zoom - 0.01f, 1.0f);
		spriteCam.update();
	}

	public boolean inBounds(float x, float y) {
		return x >= getWidth()/2.0f + 257 && x <= 1920 - getWidth()/2.0f - 257 && y >= getHeight()/2.0f + 145 && y <= 1080 - getHeight()/2.0f - 145;
	}
	...
	public void moveTo() {
		float posX = Math.max(Math.min(spriteCam.position.x, 1920 - getWidth()/2.0f - 257), getWidth()/2.0f + 257);
		float posY = Math.max(Math.min(spriteCam.position.y, 1080 - getHeight()/2.0f - 145), getHeight()/2.0f + 145);
		spriteCam.position.x -= (spriteCam.position.x-posX)/13.0f;
		spriteCam.position.y -= (spriteCam.position.y-posY)/13.0f;
		spriteCam.update();
	}
	...
	public boolean inPosition() {
		float posX = Math.max(Math.min(spriteCam.position.x, 1920.0f - getWidth()/2.0f - 257.0f), getWidth()/2.0f + 257.0f);
		float posY = Math.max(Math.min(spriteCam.position.y, 1080.0f - getHeight()/2.0f - 145.0f), getHeight()/2.0f + 145.0f);
