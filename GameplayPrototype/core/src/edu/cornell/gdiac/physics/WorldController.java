...
public abstract class WorldController implements Screen {
	...
	/** Track current ability the player has */
	protected AbilityState abilityState = AbilityState.LAME;

	protected int abilityTimer = 0;
	...
	/** The texture file for the fountains */
	private static final String DASH_FOUNTAIN_FILE = "platform/dash_fountain.png";
	private static final String FLIGHT_FOUNTAIN_FILE = "platform/flight_fountain.png";
	private static final String TRANSPARENT_FOUNTAIN_FILE = "platform/transparent_fountain.png";
	private static final String BACKGROUND_FILE = "shared/background.png";
	private static int FONT_SIZE = 64;
	private static int FOUNTAIN_FONT_SIZE = 20;
	...
	/** The font for displaying the font */
	protected BitmapFont fountainFont;
	/** The old ability gained by the player */
	protected AbilityState prevAbility;
	...
	public void preLoadContent(AssetManager manager) {
		...
		manager.load(TRANSPARENT_FOUNTAIN_FILE, Texture.class);
		assets.add(TRANSPARENT_FOUNTAIN_FILE);
	...
	public void loadContent(AssetManager manager) {
		...
		dfountainTile = createTexture(manager,DASH_FOUNTAIN_FILE,false);
		ffountainTile = createTexture(manager,FLIGHT_FOUNTAIN_FILE,false);
		tfountainTile = createTexture(manager,TRANSPARENT_FOUNTAIN_FILE,false);
		// Allocate the font
	...
	public void draw(float delta) {
		...
		if(abilityState != AbilityState.LAME) {
			String message = "Last fountain: " + abilityState.toString();
			canvas.drawText(message, fountainFont, FOUNTAIN_TEXT_X, FOUNTAIN_TEXT_Y);
		}

		//display timer for ability
		fountainFont.setColor(Color.BLUE);
		if(abilityState != AbilityState.LAME) {
			String timer = "Timer: " + abilityTimer;
			canvas.drawText(timer, fountainFont, FOUNTAIN_TEXT_X, FOUNTAIN_TEXT_Y - 20);
		}
