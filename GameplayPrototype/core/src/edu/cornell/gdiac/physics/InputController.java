...
public class InputController {
	...
	/**
	 * Returns true if the ability A button was pressed.
	 *
	 * @return true if the ability A button was pressed.
	 */
	public boolean didActivateAbility() { return activateAbilityPressed; }


	public boolean didAbility() { return abilityPressed; }
	...
	private void readKeyboard(Rectangle bounds, Vector2 scale, boolean secondary) {
		...
		abilityPressed = Gdx.input.isKeyPressed(Input.Keys.SHIFT_LEFT) || Gdx.input.isKeyPressed(Input.Keys.SHIFT_RIGHT);
